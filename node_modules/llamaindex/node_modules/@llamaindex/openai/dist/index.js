...
import { getEnv, process, uint8ArrayToBase64 } from '@llamaindex/env';
...
class OpenAI extends ToolCallLLM {
    ...
    async chat(params) {
        ...
        if (responseFormat && this.metadata.structuredOutput) {
            ...
            if ("parse" in responseFormat && "safeParse" in responseFormat) baseRequestParams.response_format = zodResponseFormat(responseFormat, "response_format");
            else {
