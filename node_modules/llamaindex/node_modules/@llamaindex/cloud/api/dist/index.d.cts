...
type ExtractMode = "FAST" | "BALANCED" | "MULTIMODAL" | "ACCURATE";
/**
...
type SupportedLlmModelNames = "GPT_4O" | "GPT_4O_MINI" | "AZURE_OPENAI_GPT_3_5_TURBO" | "AZURE_OPENAI_GPT_4O" | "AZURE_OPENAI_GPT_4O_MINI" | "AZURE_OPENAI_GPT_4" | "CLAUDE_3_5_SONNET" | "BEDROCK_CLAUDE_3_5_SONNET" | "VERTEX_AI_CLAUDE_3_5_SONNET";
type TextBlock = {
    block_type?: "text";
    text: string;
};
...
type ListTransformationDefinitionsApiV1ComponentDefinitionConfigurableTransformationsGetData = {
    body?: never;
    path?: never;
    query?: never;
    url: "/api/v1/component-definition/configurable-transformations";
};
type ListTransformationDefinitionsApiV1ComponentDefinitionConfigurableTransformationsGetResponses = {
    /**
     * Successful Response
     */
    200: Array<ConfigurableTransformationDefinition>;
};
type ListTransformationDefinitionsApiV1ComponentDefinitionConfigurableTransformationsGetResponse = ListTransformationDefinitionsApiV1ComponentDefinitionConfigurableTransformationsGetResponses[keyof ListTransformationDefinitionsApiV1ComponentDefinitionConfigurableTransformationsGetResponses];
type ListDataSourceDefinitionsApiV1ComponentDefinitionDataSourcesGetData = {
    body?: never;
    path?: never;
    query?: never;
    url: "/api/v1/component-definition/data-sources";
};
type ListDataSourceDefinitionsApiV1ComponentDefinitionDataSourcesGetResponses = {
    /**
     * Successful Response
     */
    200: Array<DataSourceDefinition>;
};
type ListDataSourceDefinitionsApiV1ComponentDefinitionDataSourcesGetResponse = ListDataSourceDefinitionsApiV1ComponentDefinitionDataSourcesGetResponses[keyof ListDataSourceDefinitionsApiV1ComponentDefinitionDataSourcesGetResponses];
type ListDataSinkDefinitionsApiV1ComponentDefinitionDataSinksGetData = {
    body?: never;
    path?: never;
    query?: never;
    url: "/api/v1/component-definition/data-sinks";
};
type ListDataSinkDefinitionsApiV1ComponentDefinitionDataSinksGetResponses = {
    /**
     * Successful Response
     */
    200: Array<DataSinkDefinition>;
};
type ListDataSinkDefinitionsApiV1ComponentDefinitionDataSinksGetResponse = ListDataSinkDefinitionsApiV1ComponentDefinitionDataSinksGetResponses[keyof ListDataSinkDefinitionsApiV1ComponentDefinitionDataSinksGetResponses];
 ...
 */
declare const listTransformationDefinitionsApiV1ComponentDefinitionConfigurableTransformationsGet: <ThrowOnError extends boolean = false>(options?: Options<ListTransformationDefinitionsApiV1ComponentDefinitionConfigurableTransformationsGetData, ThrowOnError>) => _hey_api_client_fetch.RequestResult<ConfigurableTransformationDefinition[], unknown, ThrowOnError>;
/**
 * List Data Source Definitions
 * List data source component definitions.
 */
declare const listDataSourceDefinitionsApiV1ComponentDefinitionDataSourcesGet: <ThrowOnError extends boolean = false>(options?: Options<ListDataSourceDefinitionsApiV1ComponentDefinitionDataSourcesGetData, ThrowOnError>) => _hey_api_client_fetch.RequestResult<DataSourceDefinition[], unknown, ThrowOnError>;
/**
 * List Data Sink Definitions
 * List data sink component definitions.
 */
declare const listDataSinkDefinitionsApiV1ComponentDefinitionDataSinksGet: <ThrowOnError extends boolean = false>(options?: Options<ListDataSinkDefinitionsApiV1ComponentDefinitionDataSinksGetData, ThrowOnError>) => _hey_api_client_fetch.RequestResult<DataSinkDefinition[], unknown, ThrowOnError>;
/**
 * Get Chat Apps
 */
