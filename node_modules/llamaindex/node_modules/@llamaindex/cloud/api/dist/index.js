...
var H = /\{[^{}]+\}/g, B = ({ path: t, url: r })=>{
    ...
    return e;
}, E = ({ allowReserved: t, array: r, object: e } = {})=>(i)=>{
        let o = [];
    ...
    for (let e of t){
        ...
        else o !== undefined && r.set(i, typeof o == "object" ? JSON.stringify(o) : o);
    }
    return r;
}, h = class {
    constructor(){
...
var J = (t = {})=>{
    let r = C(w(), t), e = ()=>({
        ...
        s.security && await I({
            ...s,
            security: s.security
        }), s.body && s.bodySerializer && (s.body = s.bodySerializer(s.body)), (s.body === undefined || s.body === "") && s.headers.delete("Content-Type");
        let l = S(s), f = {
            redirect: "follow",
            ...s
        }, u = new Request(l, f);
