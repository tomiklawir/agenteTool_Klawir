 ...
 */ function withContextAwareness(Base) {
    return class ContextAwareAgent extends Base {
        constructor(params){
            super(params), this.retrievedContext = null;
        ...
        async retrieveContext(query) {
            ...
            return nodes.map((node)=>node.node.getContent(schema.MetadataMode.NONE)).join("\n");
        }
...
const OpenAIContextAwareAgent = withContextAwareness(openai.OpenAIAgent);
...
exports.OpenAIContextAwareAgent = OpenAIContextAwareAgent;
