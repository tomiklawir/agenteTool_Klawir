...
import { Workflow as Workflow$1 } from '@llamaindex/workflow';
 ...
 */ class Workflow extends Workflow$1 {
    constructor(...args){
        // Need to figure out the constructor args for Workflow
        console.warn("The Workflow class exported from 'llamaindex' is deprecated. Please use workflows directly from '@llamaindex/workflow' in the future. See https://ts.llamaindex.ai/docs/llamaindex/modules/agents/workflows for usage.");
        super(...args);
    }
}
...
export { LLMQuestionGenerator, Settings, SubQuestionOutputParser, Workflow, imageToDataUrl, parseJsonMarkdown, storageContextFromDefaults };
